...
[A,rows,cols,entries,rep,field,symm] = mmread('/Users/lorenzodivito/Desktop/Universita/MetodiCalcoloScientifico/FirstProject/MatrixPositive/mtx/ex15.mtx');

xe = ones(rows,1);
b = A*xe;

%%use umfpack library for \
spparms('umfpack', 1);
